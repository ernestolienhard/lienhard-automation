...
const T = {
  ...
  fr: {
    metaTitle: "Services",
    metaDesc: "Ingénierie API, planification et gestion de projet, mise en service et rétrofit, modernisation WinCC (WinCC Unified) et cybersécurité : des solutions d'automatisation indépendantes du fabricant pour la construction industrielle de machines et d'installations.",
    heroEyebrow: "Services",
    heroH1a: "Tout pour votre automatisation, ",
    heroH1accent: "d'une seule main",
    heroSubtitle: "Du conseil à la cybersécurité, en passant par l'ingénierie API, la planification de projet, la mise en service et la modernisation : Lienhard Automation accompagne vos projets dans la construction industrielle de machines et d'installations, de manière indépendante du fabricant, précise et dans le monde entier.",
    ...
    overviewLead: "Six domaines complémentaires, dont deux thèmes spécialisés avec leur propre focus.",
    bereiche: [
      ...
      { title: "Cybersécurité", text: "Cybersécurité industrielle avec des partenaires de sécurité reconnus." },
    ],
    more: "En savoir plus",
  ...
  it: {
    metaTitle: "Servizi",
    metaDesc: "Ingegneria PLC, pianificazione e gestione di progetto, messa in servizio e retrofit, modernizzazione WinCC (WinCC Unified) e cybersecurity: soluzioni di automazione indipendenti dal produttore per la costruzione industriale di macchine e impianti.",
    heroEyebrow: "Servizi",
    heroH1a: "Tutto per la vostra automazione, ",
    heroH1accent: "da un unico fornitore",
    heroSubtitle: "Dalla consulenza alla cybersecurity, passando per l'ingegneria PLC, la pianificazione di progetto, la messa in servizio e la modernizzazione: Lienhard Automation accompagna i vostri progetti nella costruzione industriale di macchine e impianti, in modo indipendente dal produttore, preciso e in tutto il mondo.",
    ...
    overviewLead: "Sei aree complementari, inclusi due temi specialistici con un focus proprio.",
    bereiche: [
      ...
      { title: "Cybersecurity", text: "Cybersecurity industriale insieme a partner di sicurezza qualificati." },
    ],
    more: "Scopri di più",
  ...
  pt: {
    metaTitle: "Serviços",
    metaDesc: "Engenharia de PLC, planeamento e gestão de projetos, colocação em serviço e retrofit, modernização de WinCC (WinCC Unified) e cibersegurança: soluções de automação independentes do fabricante para a construção industrial de máquinas e instalações.",
    heroEyebrow: "Serviços",
    heroH1a: "Tudo para a sua automação, ",
    heroH1accent: "de uma única fonte",
    heroSubtitle: "Do aconselhamento à cibersegurança, passando pela engenharia de PLC, o planeamento de projetos, a colocação em serviço e a modernização: a Lienhard Automation acompanha os seus projetos na construção industrial de máquinas e instalações, de forma independente do fabricante, precisa e em todo o mundo.",
    ...
    overviewLead: "Seis áreas complementares, incluindo dois temas especializados com foco próprio.",
    bereiche: [
      ...
      { title: "Cibersegurança", text: "Cibersegurança industrial em conjunto com parceiros de segurança reconhecidos." },
    ],
    more: "Saber mais",
